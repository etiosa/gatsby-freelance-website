...
class Projects extends Component {
    ...
    //props.createRef(WorkRef);
    // })
    initConstu = () => {

        this.container = document.body;
        this.itemWrapper = document.querySelector('.work-header-root')
    }
...
// need to generate pages for all of them
    ...
    render() {
        return (
            <Layout>
                <Seo title="Projects" />
                <section class="work-header-root">
                ...
                {/* <div style={{ display: 'flex', width: '100%', height: '100vh', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                    <div class="grid">
                        <div class="grid-items">
                            <a aria-label="link-1" target="_blank" rel="noopener" draggable="false" class="link w-inline-block">
                                <h1 class="h1">Radioactive Games LLC</h1>
                                <div class="text">cemetery, paris</div>
                                <img class="content__img" src={ImageOne} alt="img1" />
                            </a>
                            <div class="divider"></div>
                            <a aria-label="link-2" target="_blank" rel="noopener" draggable="false" class="link w-inline-block">
                                <h1 class="h1">bir-hakem</h1>
                                <div class="text">bridge, paris</div>
                                <img class="content__img" src={ImageTwo} alt="img2" />
                            </a>
                        </div>
                        <div class="grid-items g2">
                            <div class="divider d2"></div>
                            <a aria-label="link-3" target="_blank" rel="noopener" draggable="false" class="link w-inline-block">
                                <h1 class="h1">république</h1>
                                <div class="text">people, paris</div>
                                <img class="content__img" src={ImageThree} alt="img3" />
                            </a>
...
/* 
  <section ref={el => WorkRef = el} className='work-header-root'>

            <div className='work-root'>
                <h1>Radioactive Games LLC</h1>
                <h1>MorJoy Candles</h1>
                <h1>Etiosa Obasuyi Portfiolo</h1>
                <h1>Black & Brown LLC</h1>
                <h1>Onyedap</h1>
                <h1>Wholesalerstarterkit</h1>
